...
public class TabsView extends JPanel {
    ...
    public TabsView() {
        ...
        setBackground(new Color(240, 240, 240)); // fix for LaF
        setOpaque(true);
        ...
        public TabComponent() {
            ...
            button.addActionListener(new AbstractAction() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (tabCount == 0) {
                        TabsView.this.remove(tabbedPane);
                        TabsView.this.add(placeholderLabel, BorderLayout.CENTER);
                        TabsView.this.updateUI();
                    }
                }
            });
            add(button);

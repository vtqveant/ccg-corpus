 ...
 *      напр., у всей пунктуации или орфографических ошибок (см. sentence id 25149). Т.е. хотя id у
 *      леммы проставлен, он может быть не уникален. Хуже того, у OOV-словоупотреблений могут иметься
 *      свои собственные граммемы, не определенные в словаре (PNCT), т.е. tagset в словаре и tagset в
 *      корпусе -- не одно и то же.
 */
